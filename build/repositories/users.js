            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { id: id, email: email, password: saltyPassword }];
                }
            });
        });
    };
    UsersRepository.prototype.generatePassword = function (password) {
        return __awaiter(this, void 0, void 0, function () {
...
var test = new UsersRepository('users.json');
test.create({ email: 'Laurent', password: 'Manger' }).then(function (res) {
    console.log(res);
});
